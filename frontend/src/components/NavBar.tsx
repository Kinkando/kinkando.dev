...
const ICONS = {
  ...
  medicine:
    'M9 3.75a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5A.75.75 0 019 3.75zM6.75 6A2.25 2.25 0 004.5 8.25v9A2.25 2.25 0 006.75 19.5h10.5A2.25 2.25 0 0019.5 17.25v-9A2.25 2.25 0 0017.25 6H6.75zM12 9.75a.75.75 0 01.75.75v1.5h1.5a.75.75 0 010 1.5h-1.5v1.5a.75.75 0 01-1.5 0v-1.5h-1.5a.75.75 0 010-1.5h1.5v-1.5A.75.75 0 0112 9.75z',
  login:
    ...
    <>
      ...
      {user && (
        <>
          ...
          <Link
            to="/medicine"
            className={linkClass('/medicine')}
            onClick={() => setOpen(false)}
          >
            <NavIcon name="medicine" />
            Medicine
          </Link>
          <Link
            to="/chat"
