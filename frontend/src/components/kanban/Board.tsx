            ...
            <div className="flex w-72 shrink-0 flex-col gap-2 rounded-xl border border-dashed border-gray-700 bg-gray-900 p-4">
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="cursor-pointer rounded-lg bg-indigo-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-indigo-500"
                >
                  Add
                </button>
                <button
                  ...
                  className="cursor-pointer rounded-lg bg-gray-800 px-4 py-1.5 text-sm font-medium text-gray-400 hover:bg-gray-700"
                >
                  Cancel
                </button>
              </div>
